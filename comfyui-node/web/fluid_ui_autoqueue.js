...
async function pollFolder() {
    ...
    try {
        ...
        if (changed && lastMtime > 0) {
            ...
            console.log(`[Swirl Together] New file: ${data.file} — queuing prompt`);
            app.queuePrompt(0, 1);
        }
...
function startPolling(intervalSec) {
    ...
    console.log(`[Swirl Together] Polling every ${intervalSec}s`);
    ...
    async afterConfigureGraph() {
        ...
        setTimeout(() => {
            ...
            if (node) {
                ...
                console.log("[Swirl Together] Watch node found — starting poller");
