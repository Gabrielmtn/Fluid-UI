...
(function () {
    ...
    var SLIDERS = {
        ...
        ridges: {configKey: "RIDGES", ui: {min: 0.5, max: 6, step: 0.1}, hard: {min: 0.5, max: 6}, def: 1, decimals: 1, category: "effects", perfTier: 1, mut: {min: 0.5, max: 4, step: 0.1, scope: "extended"}},
