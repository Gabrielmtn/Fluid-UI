...
(function () {
    ...
    var lwWatch = {
        ...
        scatter: function () { return window.config && window.config.SCATTER; },
        scatterBlock: function () { return window.config && window.config.SCATTER_BLOCK; },
        photoSafe: function () { return window.config && window.config.PHOTOSAFE; },
