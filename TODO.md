...
- [ ] Target model design doc — DRAFTED (docs/drawing-foundation-d0.md), AWAITING Gabriel's review + answers to its 7 open questions (incl. NEW: optional D0.5 edge-quality quick pass, raster-compositing home GL-vs-DOM):
